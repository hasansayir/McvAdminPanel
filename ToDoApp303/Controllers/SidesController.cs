...
namespace ToDoApp303.Controllers
{
    public class SidesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,CreatData,CreatedBy,UpdateDate,UpdatedBy")] Side side)
        {
            if (ModelState.IsValid)
            {
                side.CreatData = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,CreatData,CreatedBy,UpdateDate,UpdatedBy")] Side side)
        {
            if (ModelState.IsValid)
            {
                side.CreatData = DateTime.Now;
