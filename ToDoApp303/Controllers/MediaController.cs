...
namespace ToDoApp303.Controllers
{
    public class MediaController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Description,Extension,FilePath,FileSize,Year,Month,ContentType,CreatData,CreatedBy,UpdateDate,UpdatedBy")] Media media)
        {
            if (ModelState.IsValid)
            {
                media.CreatData = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Description,Extension,FilePath,FileSize,Year,Month,ContentType,CreatData,CreatedBy,UpdateDate,UpdatedBy")] Media media)
        {
            if (ModelState.IsValid)
            {
                media.UpdateDate = DateTime.Now;
            ...
            try
            {
                foreach (string fileName in Request.Files)
                {
                    ...
                    if (file !=null && file.ContentLength>0)
                    {
                        ...
                        var contextType = file.ContentType;
                        ...
                        if (!System.IO.File.Exists(uploadedLocation+categoryFolder+fileName))
                        {
